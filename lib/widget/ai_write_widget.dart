...
class AiWriteWidget extends StatefulWidget {
  const AiWriteWidget({super.key});

  @override
  State<AiWriteWidget> createState() => _AiWriteWidgetState();
}

class _AiWriteWidgetState extends State<AiWriteWidget> {
  @override
...
class MyHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    return Container(
      ...
      child: Text('写作灵感', style: TextStyle(fontSize: 16)),
    );
  }
