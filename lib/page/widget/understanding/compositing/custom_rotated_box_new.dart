...
class CustomRenderRotatedBox extends RenderBox
  ...
  void performLayout() {
    ...
    if (child != null) {
      // 旋转90
      final BoxConstraints rotatedConstraints = BoxConstraints(
  ...
  TransformLayer? pushTransform(PaintingContext context,
    ...
    if (needsCompositing) {
      ...
      context.pushLayer(layer, painter, offset,
          childPaintBounds: MatrixUtils.inverseTransformRect(
              effectiveTransform, context.estimatedBounds);
      );
      return layer;
    } else {
      context.canvas
  ...
  void _paintWithNewLayer(PaintingContext context, Offset offset,
      Matrix4 transform) {
    ...
    context.pushLayer(_transformLayer.layer!, _paintChild, offset,
        childPaintBounds:
        MatrixUtils.inverseTransformRect(transform, offset & size));
  }
